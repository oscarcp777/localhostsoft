...
class EstrategiaIndice: public ContadorReferencias {
    public:
        ...
        /**
         * Obtiene el esquema de los registros...
         */
        Esquema::puntero obtener_esquema() throw();
        /**
    ...
    protected:
         ...
         */
         EstrategiaIndice(Clave::puntero clavePrimaria, Esquema::puntero esq) throw();
    private:
	/**
	...
	/**
	 * Establece el esquema del registro...
	 */
