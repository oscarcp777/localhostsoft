...
char* EstrategiaAlmacenamientoBSharp::escribir_bloque_interno_en_bytes(BloqueInternoBSharp::puntero bloque) throw() {
	...
	BloqueInternoBSharp::iterador_ramas actualRama = bloque->primer_rama();
	BloqueInternoBSharp::iterador_ramas finRama = bloque->ultima_rama();
