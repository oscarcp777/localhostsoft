...
class Archivo: public Almacenamiento {
	public:
		 ...
		 */
		Archivo(unsigned int longitud, const std::string& nombre_archivo) throw();
		/**
		 * Constructor de la clase Archivo.
		 */
		Archivo(unsigned int longitud, const std::string& nombre_archivo, Esquema::puntero esquema, std::list<Clave::puntero>& listaClaves) throw();
		/**
		 * Constructor de la clase Archivo.
		 */
		Archivo(unsigned int longitud, const std::string& nombre_archivo, Esquema::puntero esquema, EsquemaBloque::puntero esquemaBloque, std::list<Clave::puntero>& listaClaves) throw();
		/**
